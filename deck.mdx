...
# When callbacks are helpful

- When promise chains are complex
- componentDidMount() & enzyme
- TDD
- Always?
...
<CodeSurfer
  ...
  steps={[
    ...
    {
      lines: [16],
      notes: "We can override the default handler because of mapStateToProps."
    },
    {
      range: [44, 45],
      notes: "We will also assert that click callback is called correctly"
    },
    {
      lines: [46],
...
# When is simplifying useful

- Access to the component
- When you have access to the redux actions
- TDD
...
# Redux ledger is useful when

- All async logic is powered via redux
- Actions cause other async actions and so on
